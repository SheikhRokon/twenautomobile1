...
SECRET_KEY = 'django-insecure--9e+8zp(w21s4e@#r0!&z(6tc6_4_vj0l2xbl6-#yz0pl@9pd_'
...
ROOT_URLCONF = 'automobileproject.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['automobileapp/templates',
                'userapp/templates'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
...
WSGI_APPLICATION = 'automobileproject.wsgi.application'
